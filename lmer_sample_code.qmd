...
letter_plot <- letter_plot[order(letter_plot$display, letter_plot$trt, letter_plot$muscle), ]
plot(letter_plot, main = "Letter Plot for Wool and Tension", ylab = "Estimated Marginal Means") + theme_bw()
```
