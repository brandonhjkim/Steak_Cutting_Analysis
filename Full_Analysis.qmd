...
color <- read_excel('Meat_Data.xlsx', sheet = 'sorted beef color ')
tbars <- read_excel('Meat_Data.xlsx', sheet = 'sorted beef TBARS')
ph <- read_excel('Meat_Data.xlsx', sheet = 'pH')

# For % yield, microbial colonies and ecoli 
full <- read_excel('Meat_Data.xlsx', sheet = 'everything one sheet')
apc <- read_excel('APC_Data.xlsx')
ecoli <- read_excel('Coliforms_Data.xlsx')
```
